...
if choice == "Home":    
    ...
    def personal_finance_page():
        st.image("Personal_Finance/Dasboard.png") 
        st.markdown("""##### Project Overview:
        \n This project is designed to help individuals manage their finances by encouraging them to save for essential categories such as Medical, Education, Charity, Food, Clothing, Living Expenses, and Loans.
The dataset contains multiple rows and columns capturing monthly income and expense history, enabling detailed tracking and analysis of financial behavior.
By analyzing this data, users can gain insights into their spending patterns, set realistic budgets, and make informed financial decisions.""") 
        st.image("Personal_Finance/Dasboard.png") 
        if st.sidebar.button("Back to Home"):
            switch_page("home")           
    ...
    def main():
        ...
        if st.session_state.page == "home":
            ...
            electrnic_sales, empty, empty1 = st.columns(3)
            with electrnic_sales:
        ...
        if st.session_state.page == "home":
            ...
            Sales, Finance_complts, Emergcy_room =st.columns(3)                
            with Sales:
            ...
            Accident,Patient_survey,Personal_finance = st.columns(3)
            with Accident:
            ...
            with Personal_finance:
                image_path = "Personal_Finance/Main_image.jpg"
                if not os.path.exists(image_path):
                    st.error(f"Image not found at {image_path}")
                else:
                    clicked = clickable_images(
                    ...
                    if clicked > -1:
                        switch_page("personali_finance_info")            
            ...
            patient_survey_page()
        elif st.session_state.page == "personali_finance_info":
